...
func NewFieldDef(name string, data *DataDef) *FieldDef {
...
func (this *FieldDef) GetOrAdviceIsPrimaryKey() bool {
    return this.IsPrimaryKey ||
        this.Data.Type.In(DT_AUTOINC_INT|DT_AUTOINC_INT_BIG)
}
...
func (this *FieldsDef) AddField(name string, fieldType DataType,
    size1 int, size2 int) *FieldDef {
    d := NewDataDef(fieldType, size1, size2)
...
func (this *FieldsDef) AddTime(name string) *FieldDef {
    return this.AddField(name, DT_TIME, 0, 0)
}

func (this *FieldsDef) AddDate(name string) *FieldDef {
    return this.AddField(name, DT_DATE, 0, 0)
}

func (this *FieldsDef) AddDateTime(name string) *FieldDef {
    return this.AddField(name, DT_DATETIME, 0, 0)
}
...
func (this *TableDef) IsTableBased() (bool, *TableDef) {
    return true, this
}
...
func (this *DatabaseDef) Select(fields ...Expr) *SelectRoot {
...
func (this *DatabaseDef) ExprFactory() *ExprFactory {
    return NewExprFactory()
}
*/
